  ...
  try {
      settings = await client.query(
          ...
          const settings = await client.query(
              q.Create(
                  q.Collection('loggerSettingsCollection'),
  ...
  async reload() {
    ...
    const embed = {
      ...
      "author": {
        ...
        "icon_url": "https://www.materialui.co/materialIcons/action/receipt_white_192x192.png"
      },
      "fields": [
        {
          "name": "#⃣ - Logging channel:",
          "value": `${channel}`
        },
        {
